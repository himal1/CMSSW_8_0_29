...
process.source = cms.Source("PoolSource",
                 fileNames = cms.untracked.vstring('/store/data/Run2016C/SingleMuon/AOD/23Sep2016-v1/80002/FE583291-358B-E611-942D-008CFA197404.root'))#2016SingleMuon
...
process.PATEventTree = cms.EDAnalyzer("PATEventTree",
    rootFileName                 = cms.untracked.string("SingleMuonDatasetEtab23Sep_2016B_JpsiUpsilonZ_Triggered_Compact.root"),

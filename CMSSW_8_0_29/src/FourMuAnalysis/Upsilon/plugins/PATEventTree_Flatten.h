...
class PATEventTree : public edm::EDAnalyzer {
 ...
 private:
  ...
  bool  fHLTP_DoubleMu3[3], fHLTP_DoubleMu6[3], fHLTP_DoubleMu7[3], fHLTP_Dimuon0_Jpsi_Muon[3], fHLTP_Dimuon0_Jpsi[3], fHLTP_Dimuon10_Jpsi_Barrel[3], fHLTP_TripleMu5[3], fHLTP_QuadMuon0_Dimuon0_Jpsi[3], fHLTP_QuadMuon0_Dimuon0_Upsilon[3],fHLTP_Dimuon0_Upsilon_Muon[3],fHLTP_Trimuon2_Upsilon5_Muon[3],fHLTP_TrimuonOpen_5_3p5_2_Upsilon_Muon[3], fHLTP_IsoMu27[3],fHLTP_IsoMu24[3], fHLTP_Mu50[3];
  // HLT prescalersb
  unsigned int fHLTP_DoubleMu3_PS, fHLTP_DoubleMu6_PS, fHLTP_DoubleMu7_PS, fHLTP_Dimuon0_Jpsi_Muon_PS, fHLTP_Dimuon0_Jpsi_PS, fHLTP_Dimuon10_Jpsi_Barrel_PS, fHLTP_TripleMu5_PS, fHLTP_QuadMuon0_Dimuon0_Jpsi_PS, fHLTP_QuadMuon0_Dimuon0_Upsilon_PS,fHLTP_Dimuon0_Upsilon_Muon_PS,fHLTP_Trimuon2_Upsilon5_Muon_PS,fHLTP_TrimuonOpen_5_3p5_2_Upsilon_Muon_PS, fHLTP_IsoMu27_PS,fHLTP_IsoMu24_PS, fHLTP_Mu50_PS;
  // HLT filters passed
  bool  fHLTP_DoubleMu3_Filters[5], fHLTP_DoubleMu6_Filters[5], fHLTP_DoubleMu7_Filters[5], fHLTP_TripleMu5_Filters[5], fHLTP_Dimuon0_Jpsi_Filters[7], fHLTP_QuadMuon0_Dimuon0_Jpsi_Filters[7], fHLTP_QuadMuon0_Dimuon0_Upsilon_Filters[7], fHLTP_Dimuon0_Jpsi_Muon_Filters[8], fHLTP_Dimuon10_Jpsi_Barrel_Filters[7],fHLTP_Dimuon0_Upsilon_Muon_Filters[8],  fHLTP_IsoMu27_Filters[6],fHLTP_IsoMu24_Filters[6], fHLTP_Mu50_Filters[6];
